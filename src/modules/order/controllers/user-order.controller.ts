...
export class UserOrderController {
  ...
  @ApiOkResponse({ description: 'Order created successfully', type: CreateOrderResponseDto})
  ...
  @ApiOkResponse({ description: 'Order cancelled successfully', type: CreateOrderResponseDto})
  ...
  @ApiOkResponse({ description: 'Order history', type: [CreateOrderResponseDto]})
  ...
  @ApiOkResponse({ description: 'Order found successfully', type: CreateOrderResponseDto})
