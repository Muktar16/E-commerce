...
export class ProductEntity extends AbstractEntity<ProductEntity> {
  ...
  @Expose()
  @ApiProperty({ type: 'string', description: 'Product name', example: 'Iphone 12 Pro Max' })
  @Column({ name: 'name', type: 'text' })
  name: string;

  @Expose()
  @ApiProperty({ type: 'string', description: 'Product SKU', example: 'IP12PM' })
  @Column({ name: 'sku', type: 'text', unique: true})
  sku: string;

  @Expose()
  @ApiProperty({ type: 'string', description: 'Product description', example: 'The best iPhone ever' })
  ...
  @Expose()
  @ApiProperty({ type: 'number', description: 'Product stock quantity', example: 100 })
  @Column({ name: 'stock_quantity', type: 'int', default: 0 })
  stockQuantity: number;

  @Expose()
  @ApiProperty({ type: 'array', items: { type: 'string' }, description: 'Product images', example: ['image1.jpg', 'image2.jpg']})
  @Column({ name: 'images', type: 'jsonb' })
  images: string[];

  @Expose()
  @ApiProperty({ type:'object', description: 'Product category', example: { id: 1, name: 'Electronics', description: 'Electronics' }})
